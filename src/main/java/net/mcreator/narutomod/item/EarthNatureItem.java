...
public class EarthNatureItem extends NarutoModModElements.ModElement {
	@ObjectHolder("naruto_mod:earth_nature")
	public static final Item block = null;

	public EarthNatureItem(NarutoModModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Earth Chakra Nature"));
		}
	}
}
