...
public class EightTrigramsPalmRotationItem extends NarutoModModElements.ModElement {
	@ObjectHolder("naruto_mod:eight_trigrams_palm_rotation")
	public static final Item block = null;

	public EightTrigramsPalmRotationItem(NarutoModModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("eight_trigrams_palm_rotation");
		}
