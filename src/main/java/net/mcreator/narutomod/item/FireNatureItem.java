...
public class FireNatureItem extends NarutoModModElements.ModElement {
	@ObjectHolder("naruto_mod:fire_nature")
	public static final Item block = null;

	public FireNatureItem(NarutoModModElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Fire Chakra Nature"));
		}
	}
}
