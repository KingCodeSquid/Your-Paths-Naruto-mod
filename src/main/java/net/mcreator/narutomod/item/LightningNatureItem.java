...
public class LightningNatureItem extends NarutoModModElements.ModElement {
	@ObjectHolder("naruto_mod:lightning_nature")
	public static final Item block = null;

	public LightningNatureItem(NarutoModModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lightning_nature");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Lightning Chakra Nature"));
		}
	}
}
