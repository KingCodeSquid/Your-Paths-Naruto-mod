...
public class WaterNatureItem extends NarutoModModElements.ModElement {
	@ObjectHolder("naruto_mod:water_nature")
	public static final Item block = null;

	public WaterNatureItem(NarutoModModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Water Chakra Nature"));
		}
	}
}
